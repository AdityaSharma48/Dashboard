...
<html lang="en">
    <head>
        ...
        <!-- <link rel="stylesheet" href="http://localhost/unit1/Project/create/style1.css"> -->
    ...
    <body>
        <div class="fault">
            <div class="fault_logo">
                ...
                <div class="fault_logo_text">Education<br><p
                        style="font-size: 10px;">Learning, growth,
                        knowledge,
                        skills.</p>
                </div>
            </div>
            ...
            <div class="fault_contain">
                <div class="fault_search1"><p>Dashboard</p></div>
                <div class="search">
        ...
        <div class="main">
            <div class="sidebar">
                ...
                <div class="function">
                    ...
                    <div class="common">
                        <i class="fa-sharp fa-solid fa-business-time"></i>
                        <p class="routine" style="text-decoration: none; font-size: 20px; color: black; font-weight: 500; background: none; cursor:pointer">Time Table</p>
                    </div>
                    <div class="common">
                        <i class="fa-sharp fa-solid fa-file-lines"></i>
                        <a
                            href="http://localhost/unit1/Project/Quiz.php">Exam</a>
                    </div>
                    <div class="common">
                ...
                <div class="below">
                    <div class="img_logo"> <img class="img_logo"
                            src="https://i.pinimg.com/474x/90/d3/0e/90d30e324cb60db9b07c5e08027ccc8b.jpg"
                            alt></div>
            ...
            <div class="part2">
                <div class="control">
                    ...
                    <div class="card3"
                        style="background-color: rgb(192, 136, 136);">
                        <div class="hexagon"
                            style="background-color: rgb(213, 74, 74);">
                            <i
                                class="fa-sharp fa-solid fa-person-chalkboard"></i>
                        </div>
                        <p class="title" style="background:none;">Total
                            Students</p>
                        <p class="count" style="background:none;">1220</p>
                    ...
                    <div class="card3"
                        style="background-color: rgb(109, 169, 209);">
                        <div class="hexagon">
                            <i class="fa-sharp fa-solid fa-book"></i>
                        </div>
                        <p class="title" style="background:none;">Total
                    ...
                    <div class="card3"
                        style="background-color: rgb(147, 157, 106);">
                        <div class="hexagon"
                            style="background-color: rgb(203, 221, 65);">
                ...
                <div class="graph" style="    display: flex; justify-content: space-evenly; padding-top: 20px; height: 290px;">
                    <div class="chart" style="background: #fff; padding: 20px; border-radius: 10px; box-shadow: 0 7px 25px rgba(0,0,0,0.08); width: 35%; max-width: 400px; display: flex; flex-direction: column; justify-content: center;">
                        <h2>Marks (Past 12 months)</h2>
                        <canvas id="myChart" style="display: block;box-sizing: border-box; height: 200px; max-width: 300px;"></canvas>
                    </div>
                    <div class="chart" style="background: #fff; padding: 20px; border-radius: 10px; box-shadow: 0 7px 25px rgba(0,0,0,0.08); width: 35%; max-width: 400px; display: flex; flex-direction: column; justify-content: center;">
                        <div style="display: flex; justify-content: center; flex-direction:column">
                            <h2>Marks (Past 12 months)</h2>
                            <canvas id="doughnutCanvas" style="display: block; box-sizing: border-box; height: 200px; width: 200px;"></canvas>
                        </div>
                    </div>
                </div>
            </div>
            <div class="part3">
                <div class="calender">
                    <iframe
                        ...
                        style="border: 0" max-width="300" height="300"
                ...
                <div class="Notice_board1">
                    <div class="n1">
                        ...
                        <div class="m1">
                            <a
                                href="https://www.youtube.com/results?search_query=cwh+sigma+batch">Web
                                Dev Sigma</a>
                            <a
                                href="https://www.youtube.com/results?search_query=cwh+sigma+batch">By-
                                codewithharry</a>
                        </div>
                    </div>
                    ...
                    <div class="n1">
                        ...
                        <div class="m1">
                            <a
                                href="https://www.youtube.com/watch?v=0bHoB32fuj0&list=PLgUwDviBIf0oF6QL8m22w1hIDC1vJ_BHz">DSA - STRIVER's A2Z</a>
                            <a
                                href="https://www.youtube.com/watch?v=0bHoB32fuj0&list=PLgUwDviBIf0oF6QL8m22w1hIDC1vJ_BHz">By- TakeuForward</a>
                        </div>
                    </div>
                    ...
                    <div class="n1">
                        ...
                        <div class="m1">
                            <a
                                href="https://www.youtube.com/watch?v=uB3i-qV6VdM&list=PLxCzCOWd7aiHGhOHV-nwb0HR5US5GFKFI">Artificial Intelligence
                                 </a>
                            <a
                                href="https://www.youtube.com/watch?v=uB3i-qV6VdM&list=PLxCzCOWd7aiHGhOHV-nwb0HR5US5GFKFI">By- Gate Smashers</a>
                        </div>
                    </div>
                    ...
                    <div class="n1">
                        ...
                        <div class="m1">
                            <a
                                href="https://www.youtube.com/watch?v=yRpLlJmRo2w&list=PLfqMhTWNBTe3LtFWcvwpqTkUSlB32kJop">Java B to A
                                 </a>
                            <a
                                href="https://www.youtube.com/results?search_query=cwh+sigma+batch">By- Apna College</a>
                        </div>
                    </div>
                    <div class="n1">
                        <img src= "https://i.ytimg.com/vi/7wnove7K-ZQ/hqdefault.jpg?sqp=-oaymwEmCKgBEF5IWvKriqkDGQgBFQAAiEIYAdgBAeIBCggYEAIYBjgBQAE=&rs=AOn4CLB9yXNzeGwuJbKDH8vhgMnvUjyI9A">
                        <div class="m1">
                            <a
                                href="https://www.youtube.com/watch?v=7wnove7K-ZQ&list=PLu0W_9lII9agwh1XjRt242xIpHhPT2llg">100 Days Python
                                 </a>
                            <a
                                href="https://www.youtube.com/results?search_query=cwh+sigma+batch">By- Codewithharry</a>
                        </div>
                    </div>
                    <div class="n1">
                        <img
                        ...
                        <div class="m1">
                            <a
                                href="https://www.youtube.com/watch?v=ZftI2fEz0Fw&list=PLKnIA16_Rmvbr7zKYQuBfsVkjoLcJgxHH">Mechine Learning
                                </a>
                            <a
                                href="https://www.youtube.com/watch?v=ZftI2fEz0Fw&list=PLKnIA16_Rmvbr7zKYQuBfsVkjoLcJgxHH">By- Campus X</a>
                        </div>
                    </div> 
                </div>
            </div>
        ...
        <script>
            const timetableData = {
                Monday: [
                    ...
                    { time: "11-12 PM", subject: "C: CSE316 / R", room: "33-603 / S:K23BR" },
                ...
                Tuesday: [
                    ...
                    { time: "12-01 AM", subject: "C: INT219 / R", room: "33-603 / S:K23BR" },
                    { time: "01-02 AM", subject: "C: CSE310 / R", room: "33-603 / S:K23BR" },
                ...
                Wednesday: [
                    ...
                    { time: "12-01 AM", subject: "C: CSE316 / R", room: "33-603 / S:K23BR" },
                    { time: "01-02 AM", subject: "C: CSE428 / R", room: "33-603 / S:K23BR" },
                    { time: "03-04 PM", subject: "C: CSE316 / R", room: "33-603 / S:K23BR" },
                ],
                Thursday: [
                    { time: "01-02 AM", subject: "C: CSE406 / R", room: "33-603 / S:K23BR" },
                    { time: "02-03 AM", subject: "C: INT220 / R", room: "33-603 / S:K23BR" },
                    { time: "03-04 PM", subject: "C: INT220 / R", room: "33-603 / S:K23BR" },
                    { time: "04-05 PM", subject: "C: CSE316 / R", room: "33-603 / S:K23BR" },
                ],
                Friday: [
                { time: "01-02 AM", subject: "C: CSE406 / R", room: "33-603 / S:K23BR" },
                { time: "02-03 AM", subject: "C: INT219 / R", room: "33-603 / S:K23BR" },
